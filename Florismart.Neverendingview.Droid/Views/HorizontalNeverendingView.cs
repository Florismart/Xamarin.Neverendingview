...
{
	public class HorizontalNeverendingView : HorizontalScrollView, INeverendingScrolllable
	{
		...
		public HorizontalNeverendingView (Context context) : base (context)
		{
		}

		public HorizontalNeverendingView (Context context, IAttributeSet attrs) : base (context, attrs)
		{
			initAttributes (context, attrs);
		}

		public HorizontalNeverendingView (Context context, IAttributeSet attrs, int defStyle) : base (context, attrs, defStyle)
		{
			initAttributes (context, attrs);
		}
